        ...
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-70">
            <div className="bg-white p-6 rounded-lg shadow-lg w-full max-w-lg">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                        <label className="text-black font-bold" htmlFor="description">Precio del boleto</label>
                        <input
                            type="number"
                            name="ticketPrice"
                    ...
                    <div>
                        <label className="text-black font-bold" htmlFor="description">Minimo de boletos</label>
                        <input
                            type="number"
                            name="minValue"
                    ...
                    <div>
                        <label className="text-black font-bold" htmlFor="description">imagenes</label>
                        <input
                            type="file"
                            multiple
                            accept="image/*"
